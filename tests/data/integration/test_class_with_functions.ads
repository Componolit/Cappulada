package Test_Class_With_Functions
   with SPARK_Mode => On
is
   ...
   is
      ...
      function Named_Param (This : Class; Param : Test_Class_With_Functions.Int) return Test_Class_With_Functions.Int
