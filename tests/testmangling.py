...
class Mangling(unittest.TestCase):
    ...
    def test_class_with_virtual(self):
        c = Class (name     = "With_Virtual",
                   children = [Function(name = "foo",
                                        parameters = None)])
        result = str(Namespace (name = "Capdpa", children = [c])['With_Virtual', 'foo'].Mangle())
    ...
    def test_class_with_functions_void (self):
        c = Class (name     = "With_functions",
                  children  = [Function(name = "public_function",
                                        parameters = [Argument ("arg1", Type_Reference(name=Identifier(["Capdpa", "int"])))])])

        result = str(Namespace (name = "Capdpa", children = [c])['With_functions', 'public_function'].Mangle())
    ...
    def test_class_with_functions_int (self):
        ...
        result = str(Namespace (name = "Capdpa", children = [c])['With_functions', 'named_param'].Mangle())
    ...
    def test_class_with_functions_ctor (self):
        ...
        result = str(Namespace (name = "Capdpa", children = [c])['With_functions'].children[0].Mangle())
